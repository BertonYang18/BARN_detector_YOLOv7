            ...
            if save_txt:
                ...
                for *xyxy, conf, cls in predn.tolist():
                    ...
                    if not os.path.exists(txt_root):
                        os.mkdir(txt_root)
                    with open(save_dir / 'labels' / videoname / (path.stem + '.txt'), 'a') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/monkey.yaml', help='*.data path')
